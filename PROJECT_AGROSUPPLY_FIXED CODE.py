...
def menu_utama():
    try:
        while True:
            ...
            print("===========================================================================")
            print("------------- Mohon memilih peran terlebih dahulu (admin/user) ----------")
            print("1. Menu Admin            ")
            print("-------------------------")
            print("2. Menu User             ")
            print("-------------------------")
...
def admin():
    try:
        while True:
            ...
            header_view()
            print("===========================================================================")
            print("===============--- S E L A M A T   D A T A N G   A D M I N ---=============")
            print("===========================================================================")
...
def tampilkan_akun():
    clear()
    print("=====================================================")
    print("---------- [ T A M P I L K A N   A K U N ] ----------")
    print("=====================================================")
    try:
...
def status_pembeli():
    clear()
    print("=====================================================")
    print("-------- [ S T A T U S   P E M B E L I A N ] --------")
    print("=====================================================")
    ...
    try:
        while True:
            ...
            while True:
                clear()
                print("=====================================================================")
                print("=============== S E L A M A T  D A T A N G  U S E R =================")
                print("=====================================================================")
                print("-----Di Aplikasi pemesanan Pupuk & Bibit terbaik = Agrosupply ! -----")
                print("\n======================= Silahkan pilih menu =========================")
...
def pull_gacha():
    try:
        df_voucher = pd.read_csv('voucher.csv')
        if df_voucher.empty:
            print("=====================================================")
        ...
        # MENGGUNAKAN random.choice untuk mengacak voucher
        random_row = random.choice(df_voucher.index)
        kode_voucher = df_voucher.loc[random_row, 'Kode']
        diskon_persen = df_voucher.loc[random_row, 'Diskon']
        
        print("=====================================================")
        print(f"       🎉 C O N G R A T U L A T I O N S ! 🎉")
        print(f" Anda mendapat kode voucher : {kode_voucher}")
        print(f" Diskon : {int(diskon_persen * 100)}%")
        print(" Gunakan kode voucher berikut untuk mendapat diskon \n di saat pembelian selanjutnya!")
        print("=====================================================")
        
    except FileNotFoundError:
        print("=====================================================")
        print(" File voucher.csv tidak ditemukan!")
        print(" Silakan tambahkan voucher melalui Menu Admin")
        print("=====================================================")
    except Exception as e:
        print("=====================================================")
        print(f" Gagal melakukan gacha voucher: {str(e)}")
        print(" Cek format file voucher.csv")
        print("=====================================================")
...
def status_penjualan(user):
    ...
    try:
        ...
        print("----------------------- Dikemas - Dikirim - Diterima ----------------------")
        print("\n===========================================================================")
